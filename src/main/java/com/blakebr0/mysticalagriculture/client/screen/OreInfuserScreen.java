...
public class OreInfuserScreen extends BaseContainerScreen<OreInfuserContainer> {
    private static final Identifier BACKGROUND = MysticalAgriculture.resource("textures/gui/ore_infuser.png");

    public OreInfuserScreen(OreInfuserContainer container, Inventory inv, Component title) {
    ...
    public void extractBackground(GuiGraphicsExtractor gfx, int mouseX, int mouseY, float a) {
        ...
        if (this.menu.getProgress() > 0) {
            ...
            gfx.blit(RenderPipelines.GUI_TEXTURED, BACKGROUND, x + 104, y + 51, 176, 14, i2 + 1, 16, 256, 256);
        }
    }
