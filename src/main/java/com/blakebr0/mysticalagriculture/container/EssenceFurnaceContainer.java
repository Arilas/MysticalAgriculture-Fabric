...
public class EssenceFurnaceContainer extends BaseContainerMenu {
    ...
    public EssenceFurnaceContainer(int id, Inventory playerInventory, RegistryFriendlyByteBuf buffer) {
        this(id, playerInventory, EssenceFurnaceTileEntity.createInventoryHandler(), new MachineUpgradeItemStackHandler(), new SimpleContainerData(6), buffer.readBlockPos());
    }
