...
public class ReprocessorCategory implements IRecipeCategory<RecipeHolder<IReprocessorRecipe>> {
    ...
    public static final IRecipeHolderType<IReprocessorRecipe> RECIPE_TYPE = IRecipeHolderType.create(MysticalAgriculture.resource("reprocessor"));
    ...
    @Override
    public IRecipeType<RecipeHolder<IReprocessorRecipe>> getRecipeType() {
        return RECIPE_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("jei.category.mysticalagriculture.reprocessor");
    }
