...
public final class ModCrops {
    ...
    public static final Crop BREEZE = new Crop(MysticalAgriculture.resource("breeze"), CropTier.FOUR, CropType.MOB, LazyIngredient.item("mysticalagriculture:soul_jar", MobSoulUtils.makeComponentMap(ModMobSoulTypes.BREEZE)));
