...
public class EssenceSpearItem extends BaseSpearItem implements ITinkerable {
    private static final EnumSet<AugmentType> TYPES = EnumSet.of(AugmentType.WEAPON, AugmentType.SPEAR);
    private final int tinkerableTier;
    private final int slots;

    public EssenceSpearItem(
            Identifier id,
        ...
        super(id, material, attackDuration, damageMultiplier, delay, dismountTime, dismountThreshold, knockbackTime, knockbackThreshold, damageTime, damageThreshold, p -> {
