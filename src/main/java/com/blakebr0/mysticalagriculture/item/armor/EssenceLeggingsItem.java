...
public class EssenceLeggingsItem extends BaseArmorItem implements ITinkerable {
    ...
    public EssenceLeggingsItem(Identifier id, ArmorMaterial material, int tinkerableTier, int slots) {
        super(id, material, ArmorType.LEGGINGS, p -> {
    ...
    public void inventoryTick(ItemStack stack, ServerLevel level, Entity entity, EquipmentSlot slot) {
        ...
        if (slot == EquipmentSlot.LEGS && entity instanceof Player player) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display, Consumer<Component> builder, TooltipFlag flag) {
        ...
        if (ModConfigs.AWAKENED_SUPREMIUM_SET_BONUS.get() && stack.is(ModItems.AWAKENED_SUPREMIUM_LEGGINGS)) {
