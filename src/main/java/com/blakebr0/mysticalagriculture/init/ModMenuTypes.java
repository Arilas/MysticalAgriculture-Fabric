...
import com.blakebr0.mysticalagriculture.container.MenuBlockEntityValidator;
...
public final class ModMenuTypes {
    ...
    public static final MenuType<TinkeringTableContainer> TINKERING_TABLE = register("tinkering_table",
            (id, inventory, pos) -> {
                MenuBlockEntityValidator.require(inventory, pos, TinkeringTableTileEntity.class);
                return new TinkeringTableContainer(id, inventory, TinkeringTableTileEntity.createInventoryHandler(), pos);
            });
    public static final MenuType<EnchanterContainer> ENCHANTER = register("enchanter",
            (id, inventory, pos) -> {
                MenuBlockEntityValidator.require(inventory, pos, EnchanterTileEntity.class);
                return new EnchanterContainer(id, inventory, EnchanterTileEntity.createInventoryHandler(), pos);
            });
